...
class CommandController:
    def __init__(self):
        self.templates = {
            'standard': 'standard_template.txt',
            'openers': 'openers_template.txt',
            'clickers': 'clickers_template.txt'
        }
    ...
    def generate_script(self, key: str, template_name: str, directory_name: str):
        try:
            with open('templates/' + self.templates[template_name], 'r') as file_template:
                template = file_template.read()
